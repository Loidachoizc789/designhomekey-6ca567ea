      ...
      <div className="relative z-10 section-container text-center py-20">
        ...
        >
          ...
          >
            <Button 
              size="lg" 
              className="bg-primary text-primary-foreground hover:bg-primary/90 px-10 py-7 text-lg font-medium rounded-full"
              asChild
            >
              <a href="#categories">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-border hover:bg-secondary px-10 py-7 text-lg font-medium rounded-full"
              asChild
            >
              <a href="#demo">
